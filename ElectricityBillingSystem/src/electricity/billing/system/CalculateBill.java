...
public class CalculateBill extends JFrame implements ActionListener{
    ...
    CalculateBill(){
        ...
        heading .setBounds(140, 10, 300, 25);
...
//        meternumber.add("Electric Meter");
//        meternumber.add("Solar Meter");
//        meternumber.add("Smart Meter");
        ...
        JLabel lblcity = new JLabel("Unit Consumer");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == next){
            ...
            String query2 = "insert into billl values('"+meter+"', '"+month+"', '"+units+"', '"+totalbill+"', 'Not Paid')";
            try{
                Conn c = new Conn();

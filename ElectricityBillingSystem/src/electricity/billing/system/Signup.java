...
//        setSize(700, 400);
//        setLocation(450, 150);
        setBounds(450, 150, 700, 400);//replace for setSize setLocation 
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);
        
        JPanel panel = new JPanel(); //JPanel is same as frame
        ...
        panel.setBackground(Color.WHITE); // change for background color
        panel.setLayout(null);
        panel.setForeground(new Color(34, 139, 34)); // change for text background
        add(panel);
